      ...
      >
        <div className="flex items-center">
          <Link to={"/login"} className="flex-1 cursor-pointer">
            <p className="text-dark-300 text-center py-3">Sign In</p>
          </Link>
          <Link
            to={"/register"}
          ...
          >
            <p
              to={"/register"}
              className="text-dark-500 text-center py-3 font-semibold"
            >
              Sign Up
            </p>
          </Link>
        ...
        <div className="border border-gray-100 py-4 bg-red-500 rounded-lg justify-center flex items-center space-x-5 cursor-pointer">
          ...
          <p className="text-light-500 font-medium"> Sign up with google</p>
        </div>
